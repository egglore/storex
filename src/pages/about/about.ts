...
export class AboutPage {
  ...
  flagg = true;
  marker;
  KaKaoJavascriptAPIKey = '70936816e9f132eac86235018b30b5ee';

  constructor(public navCtrl: NavController, public navParams: NavParams, public _kakaoMapsProvider: KakaoMapsProvider) {
